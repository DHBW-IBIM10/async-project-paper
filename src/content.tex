...
\subsubsection{Single-/Multithreading}
\label{issue_threads}
...
and bug-fixing.
Table \ref{tbl_maintain} gives a quick overview over the differences between Node.js 
and Vert.x in this context. Further details are provided in the following sub-sections.\\
...
& Depends on the used language. Java coding style in Vert.x e.g. differs from
