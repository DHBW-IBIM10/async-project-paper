...
synchronous transmission using the \textit{XmlHttpRequest} object which allows to request
...
as in relative terms when comparing it to peers at the same point in their lifecycle.
...
\begin{itemize}
  ...
  \item front-end JavaScript and back-end mobile teams could be merged into a single unit. 
