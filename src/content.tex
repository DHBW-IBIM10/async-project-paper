...
in the Proof of Concept are WebSockets. The WebSocket Protocol is standardized
...
server-side software and intermediaries. The data transfer part can start as
